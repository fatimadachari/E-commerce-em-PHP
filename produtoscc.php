...
<title>Paint Me - Cavaletes e Chassis</title>
...
<body>
    ...
    <div id="cc">
            ...
            <br />
            <br />
            <h1>Cavaletes e Chassis</h1>
			<?php
          include_once("conexao_fatima.php");       
		     
          $sql = "SELECT * FROM produtos where categoria='Chassis' or categoria='Cavaletes' order by rand()";
